...
def create_image_ozon(
    ...
    image = Image.open("static/images/tink/ozon.jpg")
    ...
    draw.text((210, 730), phone, fill=black, font=font)
    ...
    name = name if name else 'Озон Банк (Ozon)'
    font_size6 = 33
    ...
    pos6_y = 504
    draw.text((pos6_x, pos6_y), name, fill=(255, 255, 255), font=font6)
