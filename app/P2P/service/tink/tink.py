...
def create_image_tink(
    ...
    image = Image.open("static/images/tink/tink.jpg")
    ...
    draw.text((230, 690), phone, fill=black, font=font)
    ...
    if name:
        ...
        pos6_y = 480
        draw.text((pos6_x, pos6_y), name, fill=black, font=font6)
    else:
        font_size6 = 28
        font6 = ImageFont.truetype(BASE_FONT, font_size6)
        bbox6 = draw.textbbox((0, 0), 'Клиенту Т-Банка', font=font6)
        width6 = bbox6[2] - bbox6[0]
        pos6_x = center_x - width6 // 2
        pos6_y = 480
        draw.text((pos6_x, pos6_y), 'Клиенту Т-Банка', fill=black, font=font6)
